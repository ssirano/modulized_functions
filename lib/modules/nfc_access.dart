...
class NfcAccess extends StatefulWidget {
  @override
  _NfcAccessState createState() => _NfcAccessState();
}

class _NfcAccessState extends State<NfcAccess> {
  String tagInfo = "No FNC tag read yet";
  ...
  _checkNfcAvailability() async {
    ...
    if (!isAvailable) {
      ...
      await intent.launch();
      logger.e("NFC Uanvailable, opening settings");
    } else {
